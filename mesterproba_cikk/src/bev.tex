\section{Bevezetés}
	...
	\begin{figure}[H]
		\centering
		\subfloat[Az AFM apparátusa]{\includegraphics[width=0.45\columnwidth]{kepek/eps/AFM.eps}%
		\label{fig:afm}}
		\hfil
		\subfloat[A tű és minta modellje]{\includegraphics[width=0.45\columnwidth]{kepek/eps/tip-sample.eps}%
...
\section{A feladat} \label{sec:feladat}
	...
	\begin{figure}[!t]
		\centering
		\subfloat[Mérési eredmény]{\includegraphics[width=0.5\columnwidth]{kepek/eps/newafm_total.eps}%
		\label{fig:afm_total}}
		\hfil
		\subfloat[Mérés részlete]{\includegraphics[width=0.5\columnwidth]{kepek/eps/newafm200.eps}%
		\label{fig:afm200}}
